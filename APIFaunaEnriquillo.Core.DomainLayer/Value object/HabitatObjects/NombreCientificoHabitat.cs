...
namespace APIFaunaEnriquillo.Core.DomainLayer.Value_object.HabitatObjects
{
    public class NombreCientificoHabitat
    {
       
            public string Value { get; }

            public NombreCientificoHabitat(string value)
            {
            ...
            {
                if (obj is NombreCientificoHabitat other)
                {
