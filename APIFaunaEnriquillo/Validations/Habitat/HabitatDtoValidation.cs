...
{
    public class HabitatDtoValidation : AbstractValidator<HabitatDto>
    {
        public HabitatDtoValidation()
        {
            ...
            RuleFor(x => x.NombreCientifico)
             ...
             .MaximumLength(500).WithMessage("El Maximo de caracteres es 250");

            RuleFor(x => x.Descripcion)
              .NotEmpty().WithMessage("La Descripción es requerida.")
              .MinimumLength(3).WithMessage("El nombre común debe tener al menos 3 caracteres.")
              .MaximumLength(250).WithMessage("El Maximo de caracteres es 500");
            RuleFor(x => x.Clima)
               .NotEmpty().WithMessage("El Clima es requerido.")
               .IsInEnum().WithMessage("Clima no valido.");

            RuleFor(x => x.UbicacionGeograficaUrl)
