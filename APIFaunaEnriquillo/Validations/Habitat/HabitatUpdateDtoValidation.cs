...
{
    public class HabitatUpdateDtoValidation : AbstractValidator<HabitatUpdateDto>
    {
        public HabitatUpdateDtoValidation()
        {
            ...
            RuleFor(x => x.NombreCientifico)
             ...
             .MaximumLength(200).WithMessage("El Maximo de caracteres es 250");
